...
public class Task7 {
    public static void main(String[] args) {
        ...
        List<Integer> result = calculateSymmetricalDifference(K, integerList);
    ...
    private static List<Integer> calculateSymmetricalDifference(int k, List<Integer> integerList){
        ...
        Set<Integer> symmetricalDifference = new HashSet<>(evenSet);
        symmetricalDifference.addAll(excludedSet);
        Set<Integer> intersection = new HashSet<>(evenSet);
        intersection.retainAll(excludedSet);
        symmetricalDifference.removeAll(intersection);

        List<Integer> resultList = new ArrayList<>(symmetricalDifference);
